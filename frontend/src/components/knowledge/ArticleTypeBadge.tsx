 ...
 * Displays color-coded type badge for knowledge articles
 */

import React from 'react';
import { ArticleType, getArticleTypeLabel, getArticleTypeColor } from '@/types/knowledge';
...
export const ArticleTypeBadge: React.FC<ArticleTypeBadgeProps> = ({
  ...
  const color = getArticleTypeColor(type);
  ...
  return (
    <span
      ...
      `}
      title={`Type: ${getArticleTypeLabel(type)}`}
    >
      {showIcon && (
